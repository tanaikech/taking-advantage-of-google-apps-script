...
- [ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer): The Gemini CLI integrates with a Google Apps Script Web App acting as an MCP server, simplifying Google Workspace API authorization. This enables Gemini to automate complex tasks within Google's ecosystem, boosting productivity. Setup instructions and examples are provided.
- [FileSearchApp](https://github.com/tanaikech/FileSearchApp): Recently, I published FileSearchStore-extension, a Gemini CLI extension designed to integrate and manage the File Search feature's stores. Uploading files from your local machine to a file search store is straightforward. However, if the files are located on Google Drive, the current setup requires you to first download them and then upload them to the file search store, as the management script is run locally. This multi-step process results in a high overhead or "process cost." To eliminate this inefficiency when using files from Google Drive, I created a new library. If the management script is written in Google Apps Script, the files can be seamlessly uploaded to the file search store without the need for an intermediate download step. This Google Apps Script library, FileSearchApp, helps us manage the file search stores directly using Google Apps Script.
- [TableApp](https://github.com/tanaikech/TableApp): TableApp is a Google Apps Script library for managing Tables on Google Sheets.
- [GASADK](https://github.com/tanaikech/adk-gas): GASADK: An Agent Development Kit for Google Apps Script to build autonomous AI agents with the Gemini API, MCP, A2A, Agent Skills, and sub-agent routing.
...
### [Hearing the Mountain's Roar: How Antigravity CLI's AI Agents & IoT Data Track Volcanic Shockwaves](https://gist.github.com/tanaikech/80710d971718f884d327e33e765436de)
...
- [Gemini CLI with MCP Server Built by Web Apps of Google Apps Script](https://gist.github.com/tanaikech/4052c4dd938c845618746be420c5cc9c)
- [Generating Request Body for APIs using Gemini](https://gist.github.com/tanaikech/5c5903553f3fa6f1640229dc88e57901)
- [A Fake-Sandbox for Google Apps Script: A Feasibility Study on Securely Executing Code Generated by Gemini CLI](https://gist.github.com/tanaikech/0896697c24cf4b9e1b1038303cf734ae)
...
- [Enhanced Guide to Using Prompts in the Gemini CLI](https://gist.github.com/tanaikech/68d72654c8b7ca9879388051230a17ae)
- [Next-Level Classroom Automation: Gemini CLI, Google Classroom, and MCP](https://gist.github.com/tanaikech/be36c5f544a5e6e1a25c0cff3db04ba6)
...
- [Next-Level Google Apps Script Development](https://github.com/tanaikech/Next-Level-Google-Apps-Script-Development)
...
- [Orchestrating Agents via ADK for TypeScript and Gemini CLI](https://gist.github.com/tanaikech/89d6612b852c0d62c9791aa404b71ee0)
- [Empowering Autonomous AI Agents through Dynamic Tool Creation](https://gist.github.com/tanaikech/5c97352f92a6203577efb076e0a7209f)
...
- [Building Adaptive Learning Agents with A2UI, Gemini, and Google Apps Script](https://gist.github.com/tanaikech/0f26de9e861353ef95caa8ec50411087)
